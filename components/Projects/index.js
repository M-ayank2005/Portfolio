                        ...
                        projects.slice(0, 6).map((list, i) => {
                            return (
                                <button 
                                    data-aos="zoom-in-up"
                                    key={i} 
                                    onClick={() => list.project_url && window.open(list.project_url, '_blank')}
                                    className={`box w-full h-auto bg-dark-200 rounded-[5px] relative top-[50px] mb-[50px] mr-[5px] opacity-[.7] md:w-[250px] 
                                        hover:opacity-[1] hover:transform hover:scale-105 hover:shadow-lg cursor-pointer
                                        ...
                                        <span className={`absolute my-[-20px] right-[10px] text-[12px] flex items-center justify-start`}>
                                            {
                                                list.project_url !== "" ?
                                                    <>
                                                        <span className={`text-white-200 mr-[10px] hover:underline hover:text-white-100`}>
                                                            View
                                                        </span>
